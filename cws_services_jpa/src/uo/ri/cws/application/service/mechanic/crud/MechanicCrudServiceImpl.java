...
import uo.ri.cws.application.service.mechanic.crud.command.FindAllMechanic;
...
import uo.ri.cws.application.service.mechanic.crud.command.FindMechanicsWith1WorkOrder;
...
public class MechanicCrudServiceImpl implements MechanicCrudService {
    ...
    public List<MechanicDto> findAllMechanics() throws BusinessException {
        return executor.execute(new FindAllMechanic());
    }
    ...
    @Override
    public List<MechanicDto> findMechanicsWith1WWorkOrders()
        throws BusinessException {
        return executor.execute(new FindMechanicsWith1WorkOrder());
    }
