...
public interface SparePartCrudService {
     ...
     * @param dto
     * @return
     * @throws BusinessException        in case of: - there is another spare
     *                                  part registered with the same code - any
     *                                  of the price, stock, min stock or max
     *                                  stock is negative
     * @throws IllegalArgumentException in case of: - the code or description
     *                                  are null or empty - the dto is null
     */
    SparePartDto add(SparePartDto dto) throws BusinessException;
     ...
     * @throws BusinessException        if case of: - there is no spare part
     *                                  with such code - the spare part has
     *                                  supplies - the spare part is involved in
     *                                  any order - the spare part has
     *                                  substitutions
    ...
    /**
     * Updates the fields of the spare part identified by code except code and
     * id. Version will be internally updated. The new values has to pass the
     * same validation rules as for the add operation.
     * 
     * @param dto
     * @throws BusinessException        in case of: - the spare part code does
     *                                  not exist - any of id or description is
     *                                  null or empty - any of stock, min stock
     *                                  or max stock is negative - the price is
     *                                  negative - the version field of the
     *                                  incoming dto does not match the version
     *                                  of the persistent entity
     * @throws IllegalArgumentException if: - the dto is null - any of id or
     ...
     * @param spare part code
     * @return the spare part identified by the code or Optional.empty() if does
     *         not exist
