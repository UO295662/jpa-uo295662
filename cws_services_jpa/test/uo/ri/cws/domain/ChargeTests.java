...
class ChargeTests {
	...
	void tesChargeWithExpiredCard() {
		...
		assertThrows(IllegalStateException.class, () -> new Charge(f, t, 100.0) // Card validity date expired exception
		);
	}
	...
	void testEmptyVoucherCannotBeCharged() {
		...
		assertThrows(IllegalStateException.class, () -> new Charge(f, b, 151.0) // Not enough money exception
		);
	}
}