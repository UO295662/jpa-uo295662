...
class InvoiceAddWorkOrderTests {
	...
	/**
	 * A work order, when added to an invoice, changes its state to INVOICED Added
	 * by association
	 */
	@Test
	...
	/**
	 * All the work orders changes its state to INVOICED when added to an invoice
	 */
	@Test
	...
	/**
	 * Creates a new invoice with a delay of 100 milliseconds to avoid a collision
