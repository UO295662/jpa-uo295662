...
class SubstitutionTests {
	...
	void testSustitutionThrowsExceptionIfZero() {
		...
		assertThrows(IllegalArgumentException.class, () -> new Substitution(r, intervention, 0));
	}
	...
	void testSustitutionThrowsExceptionIfNegative() {
		...
		assertThrows(IllegalArgumentException.class, () -> new Substitution(r, intervention, -1));
	}
