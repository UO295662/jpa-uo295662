Feature: Delete a mechanic
  As a Manager
  I want to delete a mechanic in case have not been used to keep the system clean
  ...
  Scenario: Try to remove a used mechanic with interventions in work orders
